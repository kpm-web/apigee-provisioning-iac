...
module "mtls-proxy-sa" {
  source     = "github.com/terraform-google-modules/cloud-foundation-fabric//modules/iam-service-account?ref=v58.0.0"
  project_id = var.project_id
  name       = "apigee-mtls-proxy-vm"
}

module "config-bucket" {
  source     = "github.com/terraform-google-modules/cloud-foundation-fabric//modules/gcs?ref=v58.0.0"
  project_id = var.project_id
...
module "apigee-mtls-proxy-mig" {
  source            = "github.com/terraform-google-modules/cloud-foundation-fabric//modules/compute-mig?ref=v58.0.0"
  project_id        = var.project_id
  location          = var.region
...
module "nat" {
  source         = "github.com/terraform-google-modules/cloud-foundation-fabric//modules/net-cloudnat?ref=v58.0.0"
  project_id     = var.project_id
  region         = var.region
  name           = "nat-${var.region}"
